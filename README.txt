...
Adds LP EXPRESS self-service parcel terminals and LP EXPRESS courier shipping methods for WooCommerce.
...
1. Both LP Express shipping methods added to zone which called 'Lithuania' and Lithuania added to this zone regions list.
